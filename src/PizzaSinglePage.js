            ...
            {isPending || !pizza.id ? (
                ...
                <div className="card p-3">
                    <div className="card-body">
                        ...
                        <img role='pizza-img' alt={pizza.name}
                    ...
                    <div><NavLink role="back-button" to="/"><i class="bi bi-backspace"></i></NavLink> &nbsp;&nbsp;&nbsp;
                        <NavLink role="mod-button" key="y" to={"/mod-pizza/" + pizza.id}><i class="bi bi-pencil"></i></NavLink></div>
                </div>
